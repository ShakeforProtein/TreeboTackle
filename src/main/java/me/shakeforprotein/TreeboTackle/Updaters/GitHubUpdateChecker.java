package me.shakeforprotein.TreeboTackle.Updaters;
...
public class GitHubUpdateChecker {
    ...
    public GitHubUpdateChecker(TreeboTackle main) {
        this.pl = main;
    }

    public String requiredPermission = "treebotackle.admin";
    ...
    public Boolean getCheckDownloadURL() {
        ...
        if (pl.getConfig().getBoolean("externalFeatures.updates.enabled")) {
            try {
                System.out.println(badge + "Checking for updates");
                ...
                while (inputLine != null) {
                    ...
                    if (isOutOfDate) {
                        newVersion = badge + ChatColor.RED + "is out of date. Please update to version " + fullGitVersion + " from " + "https://github.com/" + pl.getConfig().getString("externalFeatures.updates.githubKey") + "/releases/latest";
                        System.out.println(newVersion);}
                    else{
                        System.out.println(badge +  "is up to date");
                    }
                    break;
                }
                in.close();
    ...
    public void checkUpdates(Player p) {
        if (isOutOfDate) {
            TextComponent updateMessage = new TextComponent(badge + ChatColor.RED + "is out of date." + ChatColor.BOLD +" [Update - " + gitVersion + "]");
